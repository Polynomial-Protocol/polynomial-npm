...
class Markets {
    ...
    async getMarkets(filters) {
        try {
            ...
            if (!chainData) {
                throw new errors_1.MarketError(`No market data found for chain ID ${this.chainId}`, { chainId: this.chainId });
            }
            ...
            if (error instanceof errors_1.MarketError) {
                throw error;
            }
            throw new errors_1.MarketError(`Failed to fetch markets: ${error instanceof Error ? error.message : "Unknown error"}`, { chainId: this.chainId, filters });
        }
    }
    /**
    ...
    async getMarketBySymbol(symbol) {
        try {
            ...
            throw new errors_1.MarketError(`Failed to fetch market for symbol ${symbol}: ${error instanceof Error ? error.message : "Unknown error"}`, { symbol, chainId: this.chainId });
        }
    }
    /**
    ...
    async getMarketById(marketId) {
        try {
            ...
            throw new errors_1.MarketError(`Failed to fetch market for ID ${marketId}: ${error instanceof Error ? error.message : "Unknown error"}`, { marketId, chainId: this.chainId });
        }
    }
    /**
    ...
    async simulateTrade(params) {
        ...
        try {
            ...
            throw new errors_1.MarketError(`Failed to simulate trade: ${error instanceof Error ? error.message : "Unknown error"}`, {
                accountId,
                marketId,
                sizeDelta: sizeDelta.toString(),
    ...
    async getMarketStats(marketId) {
        try {
            ...
            if (!market) {
                throw new errors_1.MarketError(`Market not found: ${marketId}`, { marketId });
            }
            ...
            throw new errors_1.MarketError(`Failed to fetch market stats: ${error instanceof Error ? error.message : "Unknown error"}`, { marketId });
        }
    }
    /**
    ...
    async getAvailableSymbols() {
        try {
            ...
            throw new errors_1.MarketError(`Failed to fetch available symbols: ${error instanceof Error ? error.message : "Unknown error"}`, { chainId: this.chainId });
        }
    }
}
