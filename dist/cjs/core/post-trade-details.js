...
class PostTradeDetails {
    ...
    async getPostTradeDetails(params) {
        try {
            ...
            throw new errors_1.OrderError(`Failed to get post-trade details: ${error instanceof Error ? error.message : "Unknown error"}`, { params });
        }
    }
    /**
    ...
    async getPostTradeDetailsLimit(params) {
        try {
            ...
            throw new errors_1.OrderError(`Failed to get post-trade details for limit order: ${error instanceof Error ? error.message : "Unknown error"}`, { params });
        }
    }
    /**
...
exports.PostTradeDetails = PostTradeDetails;
